...
<body>
    ...
    <div class="container">
        <form class="form" id="login">
            <h1 class="form__title"><font size="10" font color="black" font face="Calibri">Log In</font></h1>
            ...
            <p class="form__text">
                <a class="form__link" href="./" id="linkCreateAccount"><font font color="blue"font face="Calibri" font size="3">Create Account</font></a>
            </p>
        </form>
        <form class="form form--hidden" id="createAccount">
            <h1 class="form__title"><font size="10" font color="black" font face="Calibri">Sign Up</font></h1>
            <div class="form__message form__message--error"></div>
            <div class="form__input-group">
            ...
            <p class="form__text">
                <a class="form__link" href="./" id="linkLogin"><font font color="blue"font face="Verdana" font size="2">Already have an account? Log in</font></a>
            </p>
        </form>
    </div>
    <script type="module">
